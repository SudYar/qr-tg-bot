...
TODO: Рассмотреть миграцию на aiogram v3.x для улучшения:
- Производительности (асинхронная архитектура)
- Работы с форматированием (нативная поддержка HTML/Markdown entities)
